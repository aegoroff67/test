...
export default function AuEthicsAlignmentModal({ isOpen, onClose, questionCode, alignmentData }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* Header - Green theme for AU Ethics */}
        <div className="bg-green-600 text-white p-6">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-xl font-semibold">
                Australian AI Ethics Principles (2024) Alignment Information
              </h2>
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {citation && (
            <div>
              <h3 className="text-sm font-semibold text-gray-700 mb-3">Australian AI Ethics Principles Citation(s)</h3>
