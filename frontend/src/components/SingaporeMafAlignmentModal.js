          ...
          <div className="flex justify-between items-start">
            <div className="flex-1 pr-4">
              <div className="flex items-center space-x-2 mb-1">
                <span className="text-rose-200 text-sm font-medium">{questionCode}</span>
                <span className="text-rose-300">•</span>
                <span className="text-rose-200 text-sm">Singapore Model AI Governance Framework</span>
              </div>
            ...
            <button
              onClick={onClose}
              className="text-rose-200 hover:text-white transition-colors flex-shrink-0"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
            ...
            <div>
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                ...
                >
                  ...
                  <span className="text-sm text-rose-700 font-medium">View mapped controls</span>
                          ...
                          <th className="px-4 py-2 text-left font-semibold text-gray-700 border-b">
                            <span className="flex items-center gap-1">
                              ...
                              <div className="relative group">
                                ...
                                <div className="absolute top-full left-0 mt-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none w-64 z-[100] shadow-lg">
                        ...
                        {alignedControls.map((control, index) => (
                          <tr key={index} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                            ...
                            <td className="px-4 py-2 border-b border-gray-100 text-gray-700">
                              <span className="font-medium text-rose-700">{control.controlId}</span>
                              {control.description && (
