  ...
  return (
    <div className="flex items-center justify-center w-full" style={{ height: '120px', gap: '30px' }}>
      ...
      <div className="relative flex flex-col" style={{ width: '75px', height: '100px' }}>
        ...
        {/* Sector average arrow indicator (for Awareness, System, Readiness, and Orgwide with valid sector average) */}
        {(assessmentType === 'Awareness' || assessmentType === 'System' || assessmentType === 'Readiness' || assessmentType === 'Orgwide') && sectorAverage !== null && sectorAverage !== undefined && sectorAverage !== score && (
          <div
      ...
      <div className="flex flex-col items-center">
        ...
        {/* Sector average (for System, Readiness, Orgwide, and Awareness assessments) */}
        {(assessmentType === 'System' || assessmentType === 'Readiness' || assessmentType === 'Orgwide' || assessmentType === 'Awareness') && sectorAverage !== null && sectorAverage !== undefined && sectorName && (
