  ...
  const assessments = [
    {
      ...
      icon: Sprout,
      color: "green",
      tagline: "If AI is new or informal in your organisation",
      accessKey: "awareness",
    ...
    },
    {
      ...
      icon: Rocket,
      color: "blue",
      tagline: "If you're planning AI adoption but want confidence first",
      accessKey: "readiness",
    ...
    },
    {
      ...
      icon: Building2,
      color: "purple",
      tagline: "If AI is already used across teams",
      accessKey: "orgwide",
    ...
    },
    {
      ...
      icon: Bot,
      color: "teal",
      tagline: "If you need assurance for a specific AI system",
      accessKey: "system",
    ...
    },
    {
      ...
      icon: ShieldCheck,
      color: "orange",
      tagline: "If you need defensible, regulator-ready AI risk analysis",
      accessKey: "faira",
