          ...
          <div className="flex items-start">
            ...
            <div className="px-4" style={{ width: '20%' }}>
              <p className="text-sm font-bold text-gray-900 mb-2 mt-0">
                {assessmentType === 'Awareness' ? 'Awareness Tier Description' : 'Maturity Tier Description'}
              </p>
                  ...
                  <>
                    The results indicate that <strong>{assessment?.orgwide_info?.org_name || user?.organization_name}</strong> has achieved an overall Organisation-wide AI Maturity score of <strong>{summary.overall_percentage.toFixed(1)}%</strong>, placing the organisation within the <strong>{summary.overall_maturity}</strong> maturity category. <strong>{assessment?.orgwide_info?.org_name || user?.organization_name}</strong> demonstrates {
                      summary.overall_maturity === 'Leading'
                        ...
                        : summary.overall_maturity === 'Established'
                        ? 'a well-developed and consistently applied AI governance framework across most organisational domains. Governance structures, accountability mechanisms, ethical safeguards, and risk controls are operating effectively, though certain areas may still rely on manual processes or require greater cross-organisational alignment. The organisation demonstrates strong leadership engagement, documented policies, regular monitoring, and structured review cycles. While some variability exists in capability or adoption across business units, the overall maturity reflects a stable, repeatable, and responsible approach to AI governance. Strengthening lifecycle assurance, enhancing fairness and transparency practices, and increasing automation or integration of processes will help progress toward leading maturity.'
                        : summary.overall_maturity === 'Developing'
                        ? 'emerging structure and growing consistency in AI governance across the organisation. Foundational policies, roles, and processes exist, but they are not yet uniformly adopted or fully integrated across all domains. Implementation and oversight vary between teams, and some critical controls—such as transparency, fairness safeguards, and continuous monitoring—may be underdeveloped or applied inconsistently. The organisation is building momentum, with awareness increasing and key governance elements beginning to take shape. To strengthen maturity, priority should be placed on formalising governance structures, improving coordination across business units, strengthening risk and ethical oversight, and embedding systematic monitoring and review processes across the AI lifecycle.'
                        : 'nascent or inconsistent AI governance practices across most domains. Policies, processes, roles, and controls are largely undeveloped or informal, resulting in fragmented oversight and significant variability across the organisation. Key elements such as risk management, accountability, transparency, ethical safeguards, and lifecycle assurance are limited or absent. This level of maturity signals an early stage of AI governance development. Immediate focus should be placed on establishing baseline governance structures, defining organisational roles and responsibilities, developing core policies, and building foundational awareness of responsible AI principles. Strengthening risk management, data practices, and cross-organisational alignment will be essential before progressing toward more advanced AI maturity.'
                    }
                  </>
                ) : (
                  <>
              ...
              <div className="space-y-1 mt-4" data-testid="assessment-heatmap">
                ...
                return (
                  <div key={domain.domain_id} className="flex items-center">
                    ...
                    <div className={`${assessmentType === 'Awareness' ? 'w-64' : 'w-32'} flex-shrink-0 pr-4`}>
