        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 xl:grid-cols-12 gap-3 sm:gap-4 lg:gap-6 xl:gap-8 assessment-spacing">
          ...
          <div className="lg:col-span-3 xl:col-span-2">
            <Card className="sticky top-2 lg:top-4 progress-sidebar">
              ...
              <CardContent className="space-y-3 sm:space-y-4 p-3 sm:p-4 pb-6 sm:pb-8 progress-content">
                ...
                {/* Domain Progress */}
                <div className="space-y-3 sm:space-y-4 domain-progress-expanded">
                  <h4 className="font-medium text-gray-900 text-sm sm:text-base mb-2">Domain Progress</h4>
