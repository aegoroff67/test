              ...
              <CardContent className="space-y-3 sm:space-y-4 p-4 sm:p-6">
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  {domains.map(domain => {
                    ...
                    return (
                      <div key={domain.id} className={`space-y-1 p-1.5 sm:p-2 rounded-lg ${
          ...
          <div className="lg:col-span-9 xl:col-span-10">
            <Card className="mb-4 sm:mb-6">
              <CardHeader className="p-4 sm:p-6">
                ...
                {currentQuestion.explanation && (
                  <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-blue-50 rounded-lg border-l-4 border-blue-400">
                  ...
                  >
                    ...
                    <div className="flex items-start space-x-2 sm:space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="font-medium text-gray-900 mb-1 text-sm sm:text-base">Ideal (3 points)</div>
