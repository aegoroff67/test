      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600">
            <span className="font-bold">Organisation-wide AI Maturity Assessment</span> - Please provide the following information so we can tailor the assessment and reporting.
          </p>
        </div>
