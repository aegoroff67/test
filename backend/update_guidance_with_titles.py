...
async def update_guidance_with_titles():
    ...
    print(f"✅ Updated SA-4 with title: {result_sa4.modified_count} document(s)")
    
    # Update IN-3 with title
    ...
    print(f"✅ Updated IN-3 with title: {result_in3.modified_count} document(s)")
    
    # Update SU-1 with title
    ...
    print(f"✅ Updated SU-1 with title: {result_su1.modified_count} document(s)")
    
    # Update AC-3 with title
    ...
    print(f"✅ Updated AC-3 with title: {result_ac3.modified_count} document(s)")
    
    print("\n✅ All additional guidance updated with titles and formatting!")
    
    client.close()

if __name__ == "__main__":
    asyncio.run(update_guidance_with_titles())
