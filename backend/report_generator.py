...
class AMReportGenerator:
    ...
    def _get_default_template_path(self) -> str:
        """Get the default template path - using fixed preserving styles v2 template."""
        backend_dir = Path(__file__).parent
        return str(backend_dir / "templates" / "docx" / "AM_AI_SAFE_Report_TEMPLATE_preserving_styles_v2_fixed.docx")
