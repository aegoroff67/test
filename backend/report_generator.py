...
class AMReportGenerator:
    ...
    def _get_default_template_path(self) -> str:
        """Get the default template path - using final corrected v2 template with proper structure."""
        backend_dir = Path(__file__).parent
        return str(backend_dir / "templates" / "docx" / "AM_AI_SAFE_Report_TEMPLATE_preserving_styles_v2_final.docx")
    ...
    def _generate_docx_report(self, report_data: Dict[str, Any], heatmap_image: bytes) -> bytes:
        ...
        try:
            ...
            template_context = {
                ...
                # Actions for final v2 template with separate arrays for each priority table
                'actions': {
