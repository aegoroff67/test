...
def generate_complete_scoring_schema():
    ...
    # A3.6 - Group-specific Impacts → Impact (Two-part question)
    schema["questions"]["A3_6"] = {
        "id": "A3_6",
        "text": "A3.6(a) How will each impacted group be affected?",
        "type": "multiselect_with_rating",
        "domains": ["Human, Societal and Environmental Wellbeing", "Fairness", "Privacy Protection and Security"],
        "scoring": {
            "target_metric": "Impact",
            "part_a": {
                "sub_question": "A3_6a_impact_types",
                "impact_types": {
                    "Service quality changes": {"Impact": 1},
                    "Accessibility changes": {"Impact": 2},
                    "Decision-making impacts": {"Impact": 2},
                    "Delay reduction": {"Impact": -1},
                    "Bias or fairness concerns": {"Impact": 3},
                    "Data/privacy concerns": {"Impact": 2},
                    "Security concerns": {"Impact": 2},
                    "Communication changes": {"Impact": 1},
                    "Risk of exclusion": {"Impact": 3},
                    "Increased assistance/support": {"Impact": -1},
                    "None/minimal impact": {"Impact": 0}
                }
            },
            "part_b": {
                "text": "A3.6(b) Rate the overall severity of these impacts:",
                "severity_field": "A3_6b_severity",
                "severity_weight": {
                    "1": 1.0,
                    "2": 1.5,
                    "3": 2.0
            ...
            "formula": "A3_6_ImpactScore = (sum of impact modifiers) × severity_weight",
            "notes": "Part (a): Select all applicable group impacts. Part (b): Rate severity (1=Minor, 2=Moderate, 3=Major). Final impact is sum of modifiers multiplied by severity."
        }
    }
    ...
    # A5.3 - Monitoring & Evaluation Processes → CE
    schema["questions"]["A5_3"] = {
        "id": "A5_3",
        "text": "What monitoring and evaluation processes are in place?",
        "type": "multiselect",
        "domains": ["Reliability and Safety", "Accountability"],
        "scoring": {
            "target_metric": "Control_Effectiveness",
            ...
            "notes": "Each monitoring and evaluation process adds to Control Effectiveness. Multiple processes indicate comprehensive oversight."
        }
    }
    
    # A5.4 - Monitoring Frequency → CE (single select)
    schema["questions"]["A5_4"] = {
        ...
        "scoring": {
            ...
            "notes": "More frequent monitoring provides stronger control effectiveness."
        }
    }
    
    # A5.5 - Independent Review → CE
    schema["questions"]["A5_5"] = {
        "id": "A5_5",
        "text": "Has the AI solution been subject to independent review?",
        "type": "yes_no",
    ...
    # A5.6 - Monitoring Roles → CE (single select)
    schema["questions"]["A5_6"] = {
        "id": "A5_6",
        "text": "Who is responsible for monitoring and evaluation?",
        "type": "single_select",
        "domains": ["Accountability"],
        "scoring": {
            "target_metric": "Control_Effectiveness",
            ...
            "notes": "Select the primary role responsible for monitoring and evaluation."
        }
    }
    ...
    # A5.10 - Regulatory Obligations & Frameworks → Control Effectiveness (Multi-part)
    schema["questions"]["A5_10"] = {
        "id": "A5_10",
        "text": "Are there sector-specific frameworks, laws, or regulatory obligations that apply to this AI solution?",
        ...
        "scoring": {
            ...
            "options": {
                ...
                "Yes": {
                    ...
                    "subsections": {
                        "commonwealth": {
                            "field": "A5_10_commonwealth",
                            "type": "multiselect",
                            "label": "Commonwealth (Federal) Legislation",
                            "options": {
                                "Privacy Act 1988": {"Control_Effectiveness": -2},
                                "Australian Privacy Principles (APPs)": {"Control_Effectiveness": -1},
                                "Notifiable Data Breaches (NDB) Scheme": {"Control_Effectiveness": -1},
                                "Archives Act 1983": {"Control_Effectiveness": -1},
                                "Freedom of Information Act 1982": {"Control_Effectiveness": -1},
                                "Security of Critical Infrastructure Act (SOCI)": {"Control_Effectiveness": -3},
                                "Criminal Code Act (cybercrime, identity, child exploitation provisions)": {"Control_Effectiveness": -2}
                            }
                        },
                        "queensland": {
                            "field": "A5_10_qld",
                            "type": "multiselect",
                            "label": "Queensland State Legislation",
                            "options": {
                                "Information Privacy Act 2009 (Qld)": {"Control_Effectiveness": -2},
                                "Right to Information Act 2009": {"Control_Effectiveness": -1},
                                "Public Records Act 2002": {"Control_Effectiveness": -1},
                                "Child Protection Act": {"Control_Effectiveness": -3},
                                "Domestic and Family Violence Protection Act": {"Control_Effectiveness": -3},
                                "Youth Justice Act": {"Control_Effectiveness": -2},
                                "Mental Health Act": {"Control_Effectiveness": -2},
                                "Hospital and Health Boards Act (confidentiality obligations)": {"Control_Effectiveness": -2},
                                "Police Powers and Responsibilities Act": {"Control_Effectiveness": -2}
                            }
                        },
                        "sector": {
                            "field": "A5_10_sector",
                            "type": "multiselect",
                            "label": "Sector-Specific Regulatory Obligations",
                            "options": {
                                "Health information / clinical safety requirements": {"Control_Effectiveness": -2},
                                "Law enforcement / justice sector requirements": {"Control_Effectiveness": -3},
                                "Education sector obligations": {"Control_Effectiveness": -1},
                                "Transport or safety-critical operational standards": {"Control_Effectiveness": -2},
                                "Financial or taxation regulatory requirements": {"Control_Effectiveness": -2},
                                "Indigenous cultural data governance / data sovereignty": {"Control_Effectiveness": -3},
                                "Workplace surveillance obligations": {"Control_Effectiveness": -1},
                                "Safety-of-life / emergency services obligations": {"Control_Effectiveness": -2},
                                "Critical infrastructure operational safety requirements": {"Control_Effectiveness": -3}
                            }
                        },
                        "frameworks": {
                            "field": "A5_10_frameworks",
                            "type": "multiselect",
                            "label": "Frameworks, Standards, and Policies",
                            "options": {
                                ...
                                "ISO/IEC 27701 (Privacy Information Management)": {"Control_Effectiveness": -1},
                                "ISO 31000 (Risk Management)": {"Control_Effectiveness": -1},
                                "NIST AI Risk Management Framework": {"Control_Effectiveness": -2}
                            }
                        },
                        "other": {
                            "field": "A5_10_other",
                            "type": "text",
                            "label": "Other regulations, obligations, or frameworks (optional)",
                            "default_modifier": {"Control_Effectiveness": -1},
                            "notes": "Free-text field with default CE -1. Can be LLM-classified later for adjustment if needed."
                        }
                    }
                }
            },
    ...
    # B2.3 - Diverse Perspectives Used → Impact (Two-part)
    schema["questions"]["B2_3"] = {
        "id": "B2_3",
        ...
        "scoring": {
            ...
            "options": {
                ...
                "Yes": {
                    "Impact": -2,
                    "sub_question": "B2_3_perspectives",
                    "perspectives": {
                        "People with disabilities": {"Impact": -0.5},
                        "Cultural diversity": {"Impact": -0.5},
                        "Gender diversity": {"Impact": -0.5},
                        "Age diversity": {"Impact": -0.5},
                        "Indigenous perspectives": {"Impact": -0.5},
                        "Socioeconomic diversity": {"Impact": -0.5},
                        "Other": {"Impact": 0}
                    }
                }
            },
