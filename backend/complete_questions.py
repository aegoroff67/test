...
COMPLETE_QUESTIONS_DATA = [
    ...
    },
    {
        ...
        "evidence_types": 'To comply with PR-2 ("What techniques or methods do you implement to protect personal data throughout your AI system lifecycle?"), organizations must demonstrate comprehensive privacy protection measures applied consistently across all stages of AI development and operation. Key evidence types include: **Policies & Procedures** (comprehensive Privacy-by-Design policies), **Lifecycle Protection Map** (documentation showing privacy-enhancing techniques at each stage), **Technical Implementation** (evidence of specific anonymization, pseudonymization, encryption, differential privacy, federated learning, or synthetic data generation methods), **Governance & Oversight** (privacy impact assessments with DPO approvals), **Privacy Testing** (results of re-identification risk assessments and privacy effectiveness evaluations), **Data Protection Infrastructure** (evidence of secure key management and access controls), and **Continuous Monitoring** (logs showing ongoing privacy protections). In short: Compliance requires demonstrating a systematic approach to privacy protection across the entire AI lifecycle, with appropriate technical measures deployed at each stage.',
