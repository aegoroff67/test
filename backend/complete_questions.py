...
COMPLETE_QUESTIONS_DATA = [
    ...
    {
        "code": 'SE-2',
        "text": "How do you design and train your AI model to be robust against adversarial manipulation and evasion techniques?",
        "explanation": 'Adversarial manipulation targets weaknesses in AI models during training or inference by exploiting how models learn decision boundaries. This question assesses how your AI model is designed and trained to be inherently robust against adversarial techniques such as evasion, poisoning, or model exploitation.\n\nFor example, an image recognition model may be vulnerable to subtle perturbations that cause misclassification, or a language model may be susceptible to prompt manipulation that alters outputs. Addressing these risks at design time—through robustness testing and training controls—reduces the likelihood that adversarial inputs can successfully manipulate model behaviour once deployed.',
        "foundational_answer": 'No consideration is given to adversarial manipulation or robustness during model design or training.',
...
In short: compliance requires **preventive, design-time robustness controls**, not just operational security measures.""",
    ...
    {
        "code": 'SE-6',
        "text": 'What operational controls are in place to detect, respond to, and recover from adversarial attacks in production?',
        "explanation": 'Once deployed, AI systems may be targeted by adversarial attacks that attempt to manipulate inputs, degrade performance, or exploit system behaviour in real time. This question examines how your organisation detects, responds to, and recovers from adversarial attacks in production environments.\n\nFor example, an AI system processing user-generated content may experience unusual input patterns, confidence shifts, or performance degradation that signal adversarial activity. Operational controls—such as monitoring, alerting, and incident response—are essential to maintaining system integrity after deployment.',
        "foundational_answer": 'No monitoring or response mechanisms exist for detecting or responding to adversarial attacks on the AI system.',
...
**In short:** compliance requires **active monitoring, defined response capability, and recovery readiness**, not just preventive design controls.""",
    ...
    },
    {
        ...
        "additional_guidance": '**Additional Guidance: Protecting Personal Data Throughout the AI System Lifecycle**\n\nImplementing effective privacy protection techniques across the AI lifecycle is crucial for compliance, risk management, and trust. A comprehensive approach includes:\n\n- **Select appropriate methods for each stage**:\n  - Data collection: Apply consent management and data minimization\n  - Preprocessing: Use anonymization (permanent identifier removal) or pseudonymization (reversible identifier replacement)\n  - Training: Implement privacy-preserving machine learning techniques\n  - Deployment: Establish access controls and continuous monitoring\n\n- **Match protection to sensitivity**:\n  - High-risk data: Use anonymization or synthetic data\n  - Intermediate risk: Apply pseudonymization with secure key management\n  - Collaborative systems: Consider federated learning to keep data local\n\n- **Enhance with advanced approaches**:\n  - Implement encryption in transit and at rest\n  - Use techniques like k-anonymity, differential privacy, or secure multi-party computation\n  - Regularly test privacy measures for effectiveness\n\n- **Document all methods and rationale**\n\nBy systematically protecting data throughout the AI lifecycle, your organization demonstrates privacy by design while maintaining system utility.',
        "evidence_types": """To comply with PR-2, organizations must demonstrate comprehensive privacy protection measures applied consistently across all stages of AI development and operation.

**Key Evidence Types:**

• **Policies & Procedures:** Comprehensive Privacy-by-Design policies documenting protection requirements at each lifecycle stage.
• **Lifecycle Protection Map:** Documentation showing which privacy-enhancing techniques are applied at data collection, preprocessing, training, and deployment stages.
• **Technical Implementation:** Evidence of specific anonymization, pseudonymization, encryption, differential privacy, federated learning, or synthetic data generation methods.
• **Governance & Oversight:** Privacy impact assessments (PIAs) with Data Protection Officer (DPO) approvals and sign-offs.
• **Privacy Testing:** Results of re-identification risk assessments and privacy effectiveness evaluations.
• **Data Protection Infrastructure:** Evidence of secure key management systems and access control mechanisms.
• **Continuous Monitoring:** Logs and audit trails showing ongoing privacy protections and compliance checks.

**In short:** Compliance requires demonstrating a systematic approach to privacy protection across the entire AI lifecycle, with appropriate technical measures deployed at each stage.""",
    ...
    },
    {
        ...
        "additional_guidance": '**Additional Guidance: Evaluating Privacy Protection Effectiveness and Performance Impact**\n\nBalancing privacy protection with model performance requires systematic evaluation and informed trade-offs:\n\n- **Establish evaluation metrics**:\n  - Define privacy strength metrics (e.g., k-anonymity level, epsilon values for differential privacy)\n  - Measure model performance impact (accuracy, precision, recall) with and without privacy controls\n  - Document both absolute and relative changes in performance metrics\n\n- **Test privacy effectiveness**:\n  - Conduct simulated re-identification attempts to evaluate privacy strength\n  - Use privacy auditing tools to identify potential vulnerabilities\n  - Assess whether protection meets regulatory requirements and organizational standards\n\n- **Manage performance trade-offs**:\n  - Determine acceptable performance thresholds for your specific use case\n  - Adjust privacy parameters (e.g., noise level, anonymization strength) to balance protection and utility\n  - Consider supplementing training data when privacy measures significantly degrade performance\n\n- **Implement continuous improvement**:\n  - Periodically reassess as techniques evolve and new attacks emerge\n  - Document decisions about privacy-performance trade-offs for accountability\n  - Communicate privacy protection effectiveness to stakeholders appropriately\n\nSystematic evaluation ensures your privacy measures provide meaningful protection while maintaining necessary model performance for your specific context.',
        "evidence_types": """To comply with PR-5, organizations must demonstrate systematic evaluation of privacy-performance tradeoffs with evidence-based decision making.

**Key Evidence Types:**

• **Evaluation Framework:** Documented methodologies for assessing both privacy effectiveness and performance impact.
• **Privacy Strength Testing:** Results of privacy measure evaluations including re-identification attack simulations and privacy audits.
• **Performance Impact Analysis:** Comparative metrics showing model performance (accuracy, precision, recall, F1-score) with and without privacy controls.
• **Trade-off Documentation:** Records of decisions made regarding privacy-performance balancing, including rationale and approvals.
• **Mitigation Strategies:** Evidence of techniques implemented to minimize performance degradation while maintaining privacy protection.
• **Continuous Improvement:** Regular reassessment logs showing ongoing privacy-performance evaluations and adjustments.
• **External Validation:** Third-party assessments or independent audits confirming privacy effectiveness.

**In short:** Compliance requires evidence of systematic evaluation of privacy protection effectiveness, documented performance impact analysis, and justified trade-off decisions based on use case requirements.""",
    ...
    {
        "code": 'SU-1',
        "text": 'What is the environmental impact of training and deploying your AI system (e.g., of AI training and deployment, including energy usage, carbon footprint)?',
